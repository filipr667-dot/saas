...
def build_password_reset_email(user_name: str, link: str, ttl_minutes: int = 60) -> str:
    return f"""
    <div style="font-family:'IBM Plex Sans',Arial,sans-serif;max-width:600px;margin:0 auto;color:#09090b;">
      <div style="background:#0a1e3f;padding:20px 24px;border-radius:8px 8px 0 0;">
        <h2 style="color:#ffffff;margin:0;font-size:18px;font-weight:600;">Lapis IMS — Password Reset</h2>
      </div>
      <div style="border:1px solid #e4e4e7;border-top:none;padding:24px;border-radius:0 0 8px 8px;">
        <p style="font-size:13px;color:#52525b;margin:0 0 16px;">Hi {user_name},</p>
        <p style="font-size:13px;color:#52525b;margin:0 0 20px;">
          We received a request to reset the password for your Lapis IMS account.
          Click the button below to choose a new password. This link expires in {ttl_minutes} minutes.
        </p>
        <a href="{link}" style="display:inline-block;background:#1d4ed8;color:#ffffff;padding:11px 22px;
           text-decoration:none;border-radius:6px;font-size:13px;font-weight:600;">Reset Password</a>
        <p style="font-size:12px;color:#71717a;margin:24px 0 0;">
          If you didn't request this, you can safely ignore this email — your password will not change.
        </p>
        <p style="font-size:11px;color:#a1a1aa;margin-top:8px;word-break:break-all;">
          Or paste this link into your browser:<br/>{link}
        </p>
        <p style="font-size:11px;color:#a1a1aa;margin-top:24px;">
          This is an automated message from Lapis IMS — Integrated Management System.
        </p>
      </div>
    </div>"""
